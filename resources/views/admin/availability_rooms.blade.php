						...
						<form class="form-inline ml-auto" method="post" action="{{ route('admin_availability_rooms_search') }}">
							{{ csrf_field() }}
							 <div class="form-group no-border">
								 	@if(!empty($last_admin_landlord_id))
									<input type="text" class="form-control" placeholder="Search"  name="admin_landlord_id" value="{{ $last_admin_landlord_id }}">
									@else
									<input type="text" class="form-control" placeholder="Search"  name="admin_landlord_id" value="">
									@endif
							 </div>
